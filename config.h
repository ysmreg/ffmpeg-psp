...
#define FFMPEG_CONFIGURATION "--prefix=/c/YsmFilm --cross-prefix=psp- --enable-cross-compile --target-os=psp --arch=psp --enable-hardcoded-tables --enable-gpl --disable-vhook --enable-small --disable-demuxers --disable-muxers --disable-encoders --disable-decoders --disable-parsers --disable-protocols --disable-bsfs --enable-decoder=flv"
#define FFMPEG_DATADIR "/c/YsmFilm/share/ffmpeg"
#define ARCH_ALPHA 0
#define ARCH_ARM 0
#define ARCH_BFIN 0
#define ARCH_IA64 0
